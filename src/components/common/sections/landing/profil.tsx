    ...
    <section className="flex py-16">
      <div className="border-r border-black space-y-4">
        ...
        <p className="text-slate">
          ...
          dengan visi misi yang telah dirancang. Hingga saat ini telah berhasil menciptakan ratusan ribu lulusan yang agamis,
          kompeten, serta berdaya saing tinggi baik di tingkat nasional maupun internasional.
        </p>
      </div>

      <Button text={'Selengkapnya'} href="/" variant="primary" />
    </section>
  )
}
