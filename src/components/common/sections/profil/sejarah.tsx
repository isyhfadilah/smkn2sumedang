...
export const ProfilSejarah = () => {
  return (
    <section className="my-16">
      <Container className="flex justify-between items-center space-y-3">
        <div className="space-y-2">
          <p className="text-secondary text-sm">Sejarah</p>
          <h1 className="text-xl font-medium">SMK Negeri 2 Sumedang</h1>
        </div>
        <p>
